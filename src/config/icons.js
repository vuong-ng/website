...
import { ReactComponent as GglCloudApiIcon } from '../assets/icons/google-cloud-svgrepo-com.svg';
// import { ReactComponent as GgStorage } from '../assets/icons/cloud_storage.svg';
...
const Icons = {
    ...
    link: <LinkIcon />,
    web: <WebIcon />,
    flashcard: <ViewCarouselIcon />,
    orderChatbot: <AllInboxIcon />,
    python: <PythonIcon title='Python'/>,
    googleCloud: <GglCloudApiIcon title='Google Cloud'/>,
    // googleStorage: <GgStorage/>
};
